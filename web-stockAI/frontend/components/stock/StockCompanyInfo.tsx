  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      <Card className="bg-white/95 backdrop-blur-sm border-gray-200 shadow-sm">
        <CardHeader>
          <CardTitle className="text-gray-900 text-sm font-bold">Company Information</CardTitle>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="space-y-3">
            <div>
              <div className="text-sm text-gray-500">Full Name</div>
              <div className="text-sm font-extrabold text-gray-700">{stockInfo.longName || stockInfo.shortName}</div>
            </div>
            <div>
              <div className="text-sm text-gray-500">Stock Code</div>
              <div className="text-sm font-extrabold text-gray-700">{stockInfo.symbol}</div>
            </div>
            <div className="grid grid-cols-2 gap-4">
              <div>
                <div className="text-sm text-gray-500">Exchange</div>
                <div className="text-sm font-extrabold text-gray-700">{stockInfo.exchange}</div>
              </div>
              <div>
                <div className="text-sm text-gray-500">Industry</div>
                <div className="text-sm font-extrabold text-gray-700">{stockInfo.industryDisp || stockInfo.industry || 'N/A'}</div>
              </div>
            </div>
            {stockInfo.sector && (
              <div>
                <div className="text-sm text-gray-500">Sector</div>
                <div className="text-sm font-extrabold text-gray-700">{stockInfo.sectorDisp || stockInfo.sector}</div>
              </div>
            )}
            {formatAddress() && (
              <div>
                <div className="text-sm text-gray-500">Address</div>
                <div className="text-sm font-extrabold text-gray-700">{formatAddress()}</div>
              </div>
            )}
          </div>
        </CardContent>
      ...
      <Card className="bg-white/95 backdrop-blur-sm border-gray-200 shadow-sm">
        <CardHeader>
          <CardTitle className="text-gray-900 text-sm font-bold">Contact</CardTitle>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="space-y-3">
            {stockInfo.phone && (
      ...
      {stockInfo.longBusinessSummary && (
        <Card className="lg:col-span-2 bg-white/95 backdrop-blur-sm border-gray-200 shadow-sm">
          <CardHeader>
            <CardTitle className="text-gray-900 text-sm font-bold">Introduction</CardTitle>
          </CardHeader>
          <CardContent>
      ...
      {stockInfo.companyOfficers && stockInfo.companyOfficers.length > 0 && (
        <Card className="lg:col-span-2 bg-white/95 backdrop-blur-sm border-gray-200 shadow-sm">
          <CardHeader>
            <CardTitle className="text-gray-900 text-sm font-bold">Board of Directors</CardTitle>
          </CardHeader>
          <CardContent>
