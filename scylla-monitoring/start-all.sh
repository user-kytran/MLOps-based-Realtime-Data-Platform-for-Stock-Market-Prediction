...
if [ $RUN_THANOS -eq 1 ]; then
    ...
    STORE_ADDRESS="$(docker inspect --format '{{range .NetworkSehttps://grafana.com/docs/grafana-cloud/developer-resources/observability-as-code/schema-v2/timesettings-schema/ttings.Networks}}{{.IPAddress}}{{end}}' sidecar1):10911"
